	...
	public static void main(String[] args) {
		...
		try {
			...
			settings.treeFilename = new String(
					"/home/filip/Dropbox/JavaProjects/SpreaD3/data/discrete/EBOV/Makona_1561_cds_ig.GLM.MCC.tre");

			settings.locationsFilename = new String(
					"/home/filip/Dropbox/JavaProjects/SpreaD3/data/discrete/EBOV/locations.txt");

			settings.locationAttributeName = "location";

			settings.geojsonFilename = new String(
					"/home/filip/Dropbox/JavaProjects/SpreaD3/data/discrete/EBOV/combined.geojson");

			settings.outputFilename = new String("/home/filip/Dropbox/JavaScriptProjects/d3-renderer/public/ebov.json");
