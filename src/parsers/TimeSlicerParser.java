...
public class TimeSlicerParser {
	...
	public SpreadData parse() throws IOException, ImportException {
		...
		TimeSlicerLinesParser linesParser = new TimeSlicerLinesParser(rootedTree //
				);
		...
		Layer layer = new Layer(settings.tree,
					"Time Slicer visualisation", linesList, polygonsList);
	...
	private int getAssumedTrees(String file)
			throws IOException {
