...
Spread visualisation comprises 2-steps: 
Parsing is done to a JSON file (data format). 
All the style choices are done in a second, renderering step, avoiding time consuming re-runs.
