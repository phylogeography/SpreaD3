...
-render -json /home/filip/Dropbox/JavaProjects/Spread2/test_discrete.json -linesSubset bayesFactor -linesCutoff 5 -output test.kml

* map line colors to bayes factor attribute values, use built-in color schemes
-render -json /home/filip/Dropbox/JavaProjects/Spread2/test_discrete.json -linesSubset bayesFactor -linesCutoff 5 -linecolormapping bayesFactor -output test.kml

* override default line width settings:
-render -json /home/filip/Dropbox/JavaProjects/Spread2/test_discrete.json -linesSubset bayesFactor -linesCutoff 5 -linecolormapping bayesFactor -linewidth 5 -output test.kml


h3. TIME SLICING

-parse -tree /home/filip/Dropbox/JavaProjects/Spread2/data/continuous/WNV/WNV_relaxed_geo_gamma_MCC.tre -trees /home/filip/Dropbox/JavaProjects/Spread2/data/continuous/WNV/WNV_small.trees -locationTrait location -output test.json

-parse -tree /home/filip/Dropbox/JavaProjects/Spread2/data/continuous/WNV/WNV_relaxed_geo_gamma_MCC.tre -trees /home/filip/Dropbox/JavaProjects/Spread2/data/continuous/WNV/WNV_relaxed_geo_gamma.trees -locationTrait location -output test.json
...
* Renderers
  - separate min/max values for colors, widths, altitudes etc, they are not interpolated enough when attributes live on different scales [create them per attribute!]
