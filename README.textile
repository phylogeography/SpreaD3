...
* map point areas to a continuous attribute, select start and end colors
-render kml -json /home/filip/Dropbox/JavaProjects/Spread2/d3renderer/src/data/ebov_discrete.json -pointAreaMapping height -output test.kml
...
* with world map
-parse -locations /home/filip/Dropbox/JavaProjects/Spread2/data/discrete/H5N1/locationCoordinates_H5N1 -log /home/filip/Dropbox/JavaProjects/Spread2/data/discrete/H5N1/H5N1_HA_discrete_rateMatrix.log -burnin 10 -geojson /home/filip/Dropbox/JavaProjects/Spread2/data/world.geojson -output /home/filip/test_bf.json
...
* KML
  - start/end colors for KML
  - Make main frame larger
  - rename color chooser to "fixed color" (kml renderer panel)
  - change -intervals to -slices (both in discrete tree and in time slicer)
