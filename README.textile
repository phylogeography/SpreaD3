...
* with world map
-parse -locations /home/filip/Dropbox/JavaProjects/Spread2/data/discrete/H5N1/locationCoordinates_H5N1 -log /home/filip/Dropbox/JavaProjects/Spread2/data/discrete/H5N1/H5N1_HA_discrete_rateMatrix.log -burnin 10 -geojson /home/filip/Dropbox/JavaProjects/Spread2/data/world.geojson -output test_bf.json
...
h5. Hide a map layer:
topoLayer.selectAll("path").style("visibility", "hidden");

h5. Change points size:
pointsLayer.selectAll("circle").attr("r", 1);

h5. Change lines width:
linesLayer.selectAll(".line").attr("stroke-width", 3 + "px")
