...
SPREAD is a program supporting processing and visualizations of Bayesian phylogeographic models.

h1. USAGE EXAMPLES

Spread visualisation comprises 2-steps analysis. Parsing is done to a JSON file (data format), and then all the style choices are delegated to a second, renderering step, thus avoiding time consuming re-runs and facilitating different rendering possibilities. 

Spread supports KML output for viewing in GoogleEarth [www.google.com/intl/pl/earth/] as well as in-browser, interactive display of the data, driven by D3 libraries [www.d3js.org]. 
...
-render d3 -json /home/filip/Dropbox/JavaProjects/Spread2/d3renderer/data/ebov_discrete.json -output /home/filip/Pulpit/output
...
* with map
-parse -locations /home/filip/Dropbox/JavaProjects/Spread2/data/discrete/FMDV/locations.txt -log /home/filip/Dropbox/JavaProjects/Spread2/data/discrete/FMDV/FMDV_Ecuador.log -burnin 10 -map /home/filip/Dropbox/JavaProjects/Spread2/data/world.geojson -output fmdv_bf.json
...
-parse -tree /home/filip/Dropbox/JavaProjects/Spread2/data/antigenic/H3N2_mds_MCC.tre -xCoordinate antigenic2 -yCoordinate antigenic1 -hpd 80 -mrsd 2011.1 -output antigenic_test.json

* antigenic coordinates example, antigenic coordinate vs time
-parse -tree /home/filip/Dropbox/JavaProjects/Spread2/data/antigenic/H3N2_mds_MCC.tre -xCoordinate height -yCoordinate antigenic1 -hpd 80 -mrsd 2011.1 -output antigenic_test.json
